<template>
  ...
  >
    ...
    <el-main
        class="res-card-list"
    >
      <div v-for="item in infoList" class="item-body" @click="itemClick(item)">
        <div class="item-img">
          <el-image
              :src="item.img"
          />
...
const infoList = ref([
  ...
  {
    img: "http://whcm.hwadee.cn/group1/M00/00/00/wKgIB2Wg-VmAcSIkAAVKBTrC4hY42.jpeg",
  ...
  {
    img: "http://whcm.hwadee.cn/group1/M00/00/00/wKgIB2Wg-SGAAsEpAAM5ySjlLgQ762.jpg",
    title: "消息标题1",
    audited_time: "2023-02-12 16:03:15",
    src: "xxx编辑社",
    editor: "张三",
  ...
  {
    img: "http://whcm.hwadee.cn/group1/M00/00/00/wKgIB2Wg-MmAJkg2AAEtah3QYGQ720.jpg",
    title: "消息标题1",
    audited_time: "2023-02-12 16:03:15",
    src: "xxx编辑社",
    editor: "张三",
